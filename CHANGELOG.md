...
## [0.50.0-alpha](https://github.com/sweetgreen/terraform-provider-microsoft365/compare/v0.49.1-alpha...v0.50.0-alpha) (2026-08-01)


### Features

* add added resource microsoft365_graph_beta_identity_and_access_cross_tenant_access_policy ([9f9b7b2](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/9f9b7b2664aa3d2e8b1f67feb0dcfde883203765))
* add added resource microsoft365_graph_beta_identity_and_access_cross_tenant_access_policy ([#2539](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2539)) ([22b68c0](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/22b68c080c30709a375afee50538e60a116ade63))
...
* add identity schema support for all resources ([fd0696e](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/fd0696eba7a99119369c401139b35cc25da9bc80))
...
* added list resource user and updated docs ([53f6229](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/53f6229e068ea00a0afae0c6214f809466bc7694))
* added list resource user and updated docs ([#2384](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2384)) ([18363c3](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/18363c36f354663993784a29a5294a371a4525b4))
...
* added resource graph_beta_identity_and_access_cross_tenant_access_default_settings ([#2540](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2540)) ([0edaa28](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/0edaa285c0dc19b0d24a2e55c8015174b85a5d96))
* added resource graph_beta_identity_and_access_cross_tenant_access_default_settings.md ([5f63cd4](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/5f63cd44c65d6056af05f9148a6e4e32fa6fbd7b))
* added resource graph_beta_identity_and_access_cross_tenant_access_partner_settings ([#2544](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2544)) ([8ee428e](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/8ee428e6c2dea3155756420511a1f1c37204f837))
* added resource graph_beta_identity_and_access_cross_tenant_access_partner_user_sync_settings ([#2542](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2542)) ([4b44750](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/4b44750ecf607bb2d5b98965f05c0a873768615f))
...
* Added support for `microsoft365_graph_beta_device_management_windows_platform_script` ([3333200](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/3333200c0aa1f478b32294bbf5cdf168982d33c6))
* Added support for microsoft365_graph_beta_device_management_windows_platform_script ([#2397](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2397)) ([0f113b8](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/0f113b88fd8aeada9f44721c6391897363d755bc))
* added windows autopatch resources: ...... ([#2522](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2522)) ([6bff051](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/6bff051e38805507cf15782d96b36cc2d0b2eefb))
* **ci:** derive GPG signing keys from SSM instead of GitHub Secrets ([#79](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/79)) ([5244c18](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/5244c187de1bcd43b13289e77c53175f32be3d17))
* **ci:** one-time workflow to migrate signing key into SSM ([#80](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/80)) ([ce4a62e](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/ce4a62e4db8995b4087ce9350070e1e7eb17a2c3))
* enhance CrossTenantAccessDefaultSettingsMock with additional user and group mock registrations ([aeace3b](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/aeace3b3d0cb2f09fddb8cb4c6bebfc3a962185d))
* enhance guid_list_sharder to support applications and improve test structure ([#2327](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2327)) ([e8d10f0](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/e8d10f020c2c27f3cc3b48e353818a66802dad5f))
...
* Enhance StateContainer to support Identity management ([211b2b6](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/211b2b62629c785d8d25b946e83ae3fcaaa1151e))
* implement validation for CrossTenantAccessPartnerUserSyncSettings resource ([#2543](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2543)) ([b6a1ff4](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/b6a1ff450513e7a3ad727c093f1a869d9f1b558c))
...
* Support az cli for API Client ([#2493](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2493)) ([d8a50c1](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/d8a50c10e00f5497a59bd933012771bdef9c88e5))
* Support az cli for client ([5be2715](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/5be2715fdc555e17156332c9a94464790b18a0ff))
* Support username and password authentication for client ([2bd0e46](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/2bd0e463c69f5e4e786d3338dbc07f652ced692e))
* Support username and password authentication for client ([#2517](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2517)) ([e695d69](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/e695d698e5724fd1e9c34ac44553422b4fea77f2))
...
* Windows Autopilot Device Preparation Policy assignments to use standard shared model schema with type/group_id fields ([8349f59](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/8349f590643b16b0aefdf1457039d7ba022e3e3b))
...
* add AllowSystemGeneratedSetValues modifier for enhanced set management ([ad6a2ca](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/ad6a2cae376343f04bd9472b8d23193b97ee79ca))
* add gpg-public-key.asc to .gitignore for goreleaser clean build ([dc04e8e](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/dc04e8e9171daebfa2bb93185377e5d26d1e9684))
* add GraphToFrameworkStringSetFiltered function for tag filtering ([521db10](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/521db102c02e2c5337514d14a3d1a0bb0f55b759))
* add validation for Windows feature update policy resource constraints ([#2361](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2361)) ([3d5dca0](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/3d5dca09a52d5d820d4caf19d88c5443294de45f))
...
* added scripts to automate the definition of permissions for all tf block types so that 403 errors and tf doc templates describe the correct permissions  ([#2513](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2513)) ([540999e](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/540999e5f1437f0f493cdc60abb9d4b581e144bd))
* added support for panicking test cases in bi-weekly test pipeline ([#2398](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2398)) ([475301c](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/475301cda7a656417ba3f12a488189ac0ac83687))
* All errors from external packages are now properly wrapped with context using fmt.Errorf with the %w verb, satisfying the wrapcheck linter requirements. ([17a2a31](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/17a2a31411e6fdc19967fdf5e363ac591e8ecd87))
...
* **ci:** write the signing key to the Advanced parameter tier ([#81](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/81)) ([a0a5f1f](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/a0a5f1fd697632f3e78ad5b3cb18c5018b64bc21))
...
* enhance error handling in CRUD operations for MacOS and Win32 apps ([#2325](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2325)) ([5dc4595](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/5dc4595661399c274e23e9a9799759631f6d3e47))
...
* fixed args for pipeline permissions generation ([13ac8ec](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/13ac8ec8945bc3cdf7ea11ee5c4bac644704c390))
* fixed args for pipeline permissions generation ([#2515](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2515)) ([190d0e4](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/190d0e4be69a478a4ca31c166af3e5599c81c4af))
...
* for schema validation for device config assignments ([19d4a90](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/19d4a90d08d8ef31fda8fb6e10eb141198de07c0))
* for schema validation for resources using DeviceConfigurationWithAllGroupAssignmentsAndFilterSchema ([#2537](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2537)) ([122dc46](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/122dc4666811ed662685e7d3c92e95b42760f24a))
...
* migrated all dynamic errors in validate.go implementations to use sentinel errors. ([#2545](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2545)) ([32f4cf1](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/32f4cf101a8404c242bca0f8cb808487ba95ff95))
...
* resolve err113 by centralizing construct errors in sentinels and reduce Autopilot settings builder complexity to satisfy gocyclo ([6cb2d9a](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/6cb2d9ab650c4ec0a025b17ec1a9e55040147ad1))
...
* session_controls state mapping for global_secure_access_filtering_profile to prevent post-apply null inconsistency ([#2568](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2568)) ([e9df2c6](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/e9df2c6ea01e0d5fcba364fc4ecff7232d6e7482))
* split GO_ARGS and TEMPLATE_ARGS in update-graph-permissions workflow ([41f1c02](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/41f1c0287f37b629e0575c5098685649f7b0e1ac))
* standardised crud logic flow ([9b31864](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/9b31864237850b165e010344bf99416e5f77c6ec))
* standardised crud logic flow for resource group_app_role_assignment ([#2491](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2491)) ([110fc92](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/110fc9259fe2f6afa1809e630860fbf22d4a305f))
...
* Standardize assignments schema for Windows Autopilot Device Preparation Policy ([#2474](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2474)) ([01a84f6](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/01a84f6890aaaaed7f577a54a1b086d8cfc2a911))
...
* update Entra ID client tests and middleware to prevent gzip compression on OAuth requests ([852d9f2](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/852d9f2f970a6917ca76979b0e59e4036b3c6c34))
* update Entra ID client tests and middleware to prevent gzip compression on OAuth requests ([#2519](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2519)) ([e3feb22](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/e3feb22594d8aad4b0940996115658543a2baa1b))
* Update Group resource CRUD methods to utilize new types package ([a369d2b](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/a369d2be5ed3e318518307258302d585b6083ed1))
* Update Group resource CRUD methods to utilize new types package ([#2494](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2494)) ([d06b976](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/d06b9766bb03aaa788e4d9ea510f20a6d58deed9))
...
* Use PUT instead of PATCH for windows_autopilot_device_preparation_policy updates to handle settings navigation property ([567a8b4](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/567a8b4a071ac4a5b358fe011bfa8fd040dd54ce))
* Use PUT instead of PATCH for windows_autopilot_device_preparation_policy updates to handle settings navigation property ([#2489](https://github.com/sweetgreen/terraform-provider-microsoft365/issues/2489)) ([71682f4](https://github.com/sweetgreen/terraform-provider-microsoft365/commit/71682f44c092ee48beb2199bee9698f0ca9a60bc))
